...
<body>
	...
	<h2>자료실 등록</h2>
	<hr>
	<form method="post" action="/bitstudy/html/library/libraryinsert" enctype="multipart/form-data">
		<div>
			제목 : <input type="text" name="title" id="title">
		</div>
		<div>
			내용 : <textarea rows="8" cols="55" name="content" id="content"></textarea>
		</div>
		<div>
			첨부파일 : <input type="file" name="uploadFile" id="uploadFile">
		</div>
		<button>등록</button>
