...
function Calendar_constructor(element, overrides) {
	...
	t.nextYear = nextYear;
	t.today = today;
	//t.createPlan = createPlan;		//수정한곳.. 추가했더니 에러남
	t.gotoDate = gotoDate;
...
var dpComputableOptions = {
	...
	buttonText: function(dpOptions) {
		return {
			...
			createPlan: stripHtmlEntities(dpOptions.currentText)  //수정한곳
		};
	},
