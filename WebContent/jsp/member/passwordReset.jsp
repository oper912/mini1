		...
		<div id="content">
			<div class="container pull-center">
				<div class="member-border">
					<form method="post" class="form-member" action="${pageContext.request.contextPath}/jsp/member/pwreset">
						<h2 class="form-member-heading">비밀번호재설정</h2>
						<P>
						...
						<input type="hidden" name="opt" value="pwreset">
